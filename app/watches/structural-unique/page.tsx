...
export default function StructuralUniquePage() {
  ...
  const features = [
    { icon: Star, title: "Deconstructed Design", description: "Avant-garde horological architecture" },
    { icon: Shield, title: "Visible Movement", description: "Transparent mechanical poetry" },
    { icon: Check, title: "Platinum Innovation", description: "Revolutionary case construction" },
  ]

  const specifications = [
    { label: "Case Material", value: "950 Platinum with Sapphire Crystal" },
    { label: "Case Diameter", value: "42mm" },
    { label: "Movement", value: "Skeleton automatic, 80h power reserve" },
    { label: "Water Resistance", value: "100 meters" },
    { label: "Limited Edition", value: "Unique piece - 1 of 1" },
  ...
  return (
    <main className="min-h-screen bg-obsidian text-ivory">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div ref={imageRef} className="relative">
              <div className="aspect-square bg-charcoal shadow-dark overflow-hidden group">
                <Image
                  src="/images/pt7.jpg"
                  alt="Structural Unique - Luxury Platinum Watch"
                  fill
            ...
            <div ref={contentRef} className="space-y-8">
              ...
              <div className="product-element">
                <div className="font-display-light text-3xl lg:text-4xl text-ivory mb-2">USD 350,000</div>
                <div className="font-body-refined text-sm text-pearl">Unique piece - One of a kind</div>
              </div>

              <div className="product-element space-y-4">
                <p className="font-body-refined text-lg text-pearl leading-relaxed">
                  An avant-garde expression of horological artistry and innovation. The Structural Unique challenges
                  conventional watchmaking through radical deconstruction and transparent architecture.
                </p>
                <p className="font-body-refined text-pearl leading-relaxed">
                  This singular timepiece represents the ultimate fusion of technical mastery and artistic vision, where
                  every component becomes a visible celebration of mechanical poetry.
                </p>
              </div>
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <div className="mt-16 text-center">
            <div className="bg-charcoal border-dark p-8 lg:p-12">
              <h3 className="font-display-light text-2xl text-accent mb-6 text-glow-accent">Singular Vision</h3>
              <p className="font-body-refined text-pearl leading-relaxed max-w-2xl mx-auto">
                This unique timepiece represents three years of development and innovation. Every element has been
                reimagined, resulting in a watch that exists at the intersection of haute horlogerie and contemporary
                art.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-charcoal">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          ...
          <p className="font-body-refined text-xl text-pearl mb-8 leading-relaxed">
            Experience this singular masterpiece in an exclusive private presentation at our Geneva atelier.
          </p>
      ...
      {/* Waitlist Form Modal */}
      <WaitlistForm isOpen={isWaitlistOpen} onClose={() => setIsWaitlistOpen(false)} watchName="Structural Unique" />
